...
const SUPER_ADMIN_NAV: RoleNavItem[] = [
  ...
  { label: "Product Approval", slug: "product-approval", icon: PackageCheck, comingSoon: false },
  ...
  { label: "Business Types", slug: "business-types", icon: Briefcase, comingSoon: false },
